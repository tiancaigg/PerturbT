...
## requirements
when writing ipynb, add label to each cell, such as comment "#1.1", "#2.3", easier to identify which cell has bug. used in HPC environment, old GPU V100 or new GPU H200, need to allow user to restore running (if interrupted).